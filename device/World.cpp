...
void World::finalize()
{
  ...
  if (m_zeroSurfaceData) {
      reportMessage(ANARI_SEVERITY_DEBUG,
          "anari_cycles::World found %zu surfaces in zero instance",
  ...
  if (m_zeroVolumeData) {
      reportMessage(ANARI_SEVERITY_DEBUG,
          "anari_cycles::World found %zu volumes in zero instance",
  ...
  if (m_zeroLightData) {
      reportMessage(ANARI_SEVERITY_DEBUG,
          "anari_cycles::World found %zu lights in zero instance",
